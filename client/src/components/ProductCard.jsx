            ...
            <section className="bg-white flex items-center justify-center px-4 py-16">
                <div className="flex flex-wrap items-stretch justify-center gap-5">
                    {products.map((item, index) => (
                        <div key={index} className="border border-zinc-200 hover:border-zinc-300 transition-colors rounded-xl p-2 flex flex-col w-46 relative">
                            ...
                            <div className="flex items-center gap-2 px-2 mt-auto">
                                ...
                                <span className="text-xs p-1 rounded text-white bg-secondary">55 sold</span>
                            </div>
                        </div>
                    ))}
                </div>
