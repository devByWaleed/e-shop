const ProductCard = () => {
    ...
    return (
        <div className="flex items-center justify-center">
            ...
            <div className="border border-zinc-200 hover:border-zinc-300 transition-colors rounded-xl px-2 py-7 flex flex-col relative">
                ...
                <div className="flex items-center justify-center h-32 mb-2 pt-4">
                    <img src={""} alt={""} className="max-h-full max-w-full object-contain" />
                </div>
                ...
                <div className="flex items-center gap-2 px-2 mt-auto">
                    ...
                    <span className="text-xs p-1 rounded font-bold text-secondary">"55 sold"</span>
                </div>
            </div>
        </div>
    )
