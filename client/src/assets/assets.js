...
export const productData = [
    ...
    // ==========================================
    {
        ...
        description: "Supercharged by the M2 Pro chip, this MacBook Pro delivers exceptional performance whether it's plugged in or on battery power, featuring a stunning Liquid Retina XDR display.",
    ...
    },
    {
        ...
        description: "Strikingly thin design combined with impressive speed and power efficiency inside an aluminum enclosure. Built to handle productivity tasks effortlessly on the move.",
    ...
    },
    {
        ...
        description: "Premium build quality features a stunning 4-sided InfinityEdge display. Exceptional raw performance combined with top-tier portability for modern professionals.",
    ...
    },
    {
        ...
        description: "High-octane gaming meets ultra-portable design. Features an incredible 120Hz display with massive graphical capabilities wrapped inside a compact 14-inch chassis.",
    ...
    },
    {
        ...
        description: "Extremely versatile 360-degree hinge allows adaptivity between laptop, tent, and tablet modes. Perfect for student work configurations and daily streaming.",
    ...
    // ==========================================
    {
        ...
        description: "Features Dynamic Island interactive notifications, an advanced 48MP main camera setup, and the highly efficient A16 Bionic computing processing chip.",
    ...
    },
    {
        ...
        description: "Includes an integrated S-Pen stylus, an industry-leading 200MP camera sensor with incredible Nightography systems, and the ultimate Snapdragon processors.",
    ...
    },
    {
        ...
        description: "Turbocharged by the desktop-class Apple M1 chip. Supports Apple Pencil 2 and Magic Keyboards to turn your tablet configuration into a digital design workstation.",
    ...
    },
    {
        ...
        description: "Google's smartest phone processing architecture yet, driven by the custom Tensor G2 chip. Unlocks top-tier computational photography elements instantly.",
    ...
    },
    {
        ...
        description: "Blazing fast computing architecture paired with a signature Hasselblad Ambient Camera system and industry-defining 100W wired smart battery charging.",
    ...
    // ==========================================
    {
        ...
        description: "Equipped with industry-leading hi-fi grade ESS 9281 Quad DAC processors and an AI Noise-Canceling Microphone for pristine, immersive crystal-clear gaming communication.",
    ...
    },
    {
        ...
        description: "Industry-leading active noise cancellation engineered with two processing chips and eight total microphones. Stunning high-resolution audio fidelity outputs.",
    ...
    },
    {
        ...
        description: "Experience lightning-fast processing loads with an ultra-high-speed SSD drive, deeper gameplay immersion with haptic controller feedback, and next-gen gaming design.",
    ...
    },
    {
        ...
        description: "Features a vibrant 7-inch OLED screen display, a wide adjustable system storage kickstand, a new wired LAN dock port, and 64GB of expandable internal layout storage.",
    ...
    },
    {
        ...
        description: "Iconic operational gaming structural layout meets modern mechanical-optical hybrid switches, alongside LIGHTSPEED enterprise-grade wireless protocols and clean RGB configurations.",
    ...
    // ==========================================
    {
        ...
        description: "Nike's first lifestyle Air Max shoe delivers style, comfort, and big attitude. Features a prominent wrap-around visible air unit window for cushioned steps.",
    ...
    },
    {
        ...
        description: "Experience epic energy feedback with the newest generation of Ultraboost cushioning material configurations. Crafted alongside breathable Primeknit structures.",
    ...
    },
    {
        ...
        description: "The iconic sneaker architecture that started it all. Premium split-grain leather fabrics matched alongside classic sports high-top structural security systems.",
    ...
    },
    {
        ...
        description: "An edgy street-style modification of a vintage coastal lifestyle design. Features durable solid leather upper layers combined with chunky progressive midsoles.",
    ...
    },
    {
        ...
        description: "Built to hold up against outdoor terrains. Features technical mesh construction alongside classic multi-surface rubber traction patterns on outer base walls.",
    ...
    // ==========================================
    {
        ...
        description: "Clean aesthetic features a genuine brown leather strap and high-accuracy Japanese quartz internal mechanisms inside a polished stainless steel framework housing.",
    ...
    },
    {
        ...
        description: "Premium weight configuration featuring dual time registers, tachymeter accent scales, and deep water-resistant protection ratings for elegant statement wear.",
    ...
    },
    {
        ...
        description: "The most recognizable style in the history of sunglasses. Features crystal clear UV protective lenses inside high-strength structural acetate frame cuts.",
    ...
    },
    {
        ...
        description: "Handcrafted from top-grain leather skins. Features built-in shielding technologies to safely block data theft scanning systems from accessing bank cards.",
    ...
    },
    {
        ...
        description: "Designed to meet modern commuting layouts. Includes dedicated padded laptop protective slots alongside organized zippered spacing boundaries for travel utilities.",
